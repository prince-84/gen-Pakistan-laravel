<section class="py-24 bg-white overflow-hidden" id="aboutSection">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-8">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="text-sm font-black tracking-[0.2em] text-corporate-accent uppercase">About Us</span>
                </div>
                ...
                <div class="text-slate-600 leading-relaxed space-y-8 mb-12 max-w-3xl font-medium about-content">
                    <p>
            ...
            <!-- Profile Card -->
            <div class="about-profile lg:col-span-4">
                <div class="bg-slate-50 p-10 rounded-3xl border border-slate-100 shadow-2xl shadow-slate-200/50 flex flex-col items-center text-center relative overflow-hidden group">
                    ...
                    <div class="relative w-48 h-48 mb-8 rounded-full overflow-hidden border-[10px] border-white shadow-xl z-10 transition-transform duration-700 group-hover:scale-105">
                        <img src="/images/kashif-khan.png" alt="Kashif Khan" class="w-full h-full object-cover" />
                    </div>
                    <h3 class="text-2xl font-semibold text-corporate-primary mb-2">Kashif Khan</h3>
                    <p class="text-sm text-corporate-accent font-bold uppercase tracking-widest mb-6">Managing Director</p>
                    <p class="text-slate-500 text-sm font-medium leading-relaxed">Driving strategic growth and enterprise excellence within the regional ecosystem.</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    gsap.from("#aboutSection .about-content, #aboutSection .about-button, #aboutSection .about-profile", {
        scrollTrigger: {
